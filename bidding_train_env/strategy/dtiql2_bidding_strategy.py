...
from bidding_train_env.baseline.dtiql2.dtiql import DecisionTransformerIQL as DecisionTransformer
...
class PlayerBiddingStrategy(BaseBiddingStrategy):
    ...
    def __init__(self, budget=100, name="PlayerStrategy", cpa=2, category=1):
        ...
        model_path = os.path.join(dir_name, "saved_model", "DTIQL2test", "dt.pt")
        picklePath = os.path.join(dir_name, "saved_model", "DTIQL2test", "normalize_dict.pkl")
