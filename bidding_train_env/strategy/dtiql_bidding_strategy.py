...
from bidding_train_env.baseline.dtiql.dtiql import DecisionTransformerIQL as DecisionTransformer
...
class PlayerBiddingStrategy(BaseBiddingStrategy):
    ...
    def __init__(self, budget=100, name="PlayerStrategy", cpa=2, category=1):
        ...
        model_path = os.path.join(dir_name, "saved_model", "DTIQLtest", "dt.pt")
        picklePath = os.path.join(dir_name, "saved_model", "DTIQLtest", "normalize_dict.pkl")

        with open(picklePath, 'rb') as f:
            normalize_dict = pickle.load(f)
        self.model = DecisionTransformer(16, 1, state_mean=normalize_dict["state_mean"],
    ...
    def bidding(self, timeStepIndex, pValues, pValueSigmas, historyPValueInfo, historyBid,
        ...
        alpha = self.model.actors.take_actions(test_state,
